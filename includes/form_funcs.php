...
function getCapture($fields) {
    $xml = '<?xml version="1.0"?>
      <litleOnlineRequest version="9.9" xmlns="http://www.litle.com/schema" merchantId="'.$fields['merchantId'].'">
        <authentication>
            <user>'.$fields['user'].'</user>
            <password>'.$fields['password'].'</password>
        </authentication>
        <capture id="'.$fields['id'].'" reportGroup="'.$fields['reportGroup'].'" customerId="'.$fields['customerId'].'">
            <litleTxnId>'.$fields['litleTxnId'].'</litleTxnId>
        </capture>
      </litleOnlineRequest>';
...
function getAuth($fields) {
    $xml = '<?xml version="1.0"?>
      <litleOnlineRequest version="9.9" xmlns="http://www.litle.com/schema" merchantId="'.$fields['merchantId'].'">
        ...
        <authorization id="'.$fields['id'].'" reportGroup="'.$fields['reportGroup'].'" customerId="'.$fields['customerId'].'">
            <orderId>'.$fields['orderId'].'</orderId>
            <amount>'.number_format($fields['amount']*100,0,'.','').'</amount>
            <orderSource>ecommerce</orderSource>
            <billToAddress>
                <name>'.$fields['name'].'</name>
                <addressLine1>'.$fields['address'].'</addressLine1>
